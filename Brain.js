class Brain {
    ...
    setAsMyMultipliers() {
        this.multipliers = {
            holeCountMultiplier: 50,// * random(0, 2),
            openHoleCountMultiplier: 50,// * random(0, 2),
            maximumLineHeightMultiplier: 50,// * random(0, 2),
            addedShapeHeightMultiplier: 50,// * random(0, 2),
            pillarCountMultiplier: 50,// * random(0, 2),
            blocksInRightMostLaneMultiplier: 50,// * random(0, 2),
            nonTetrisClearPenalty: 50,// * random(0, 2),
            blocksAboveHolesMultiplier: 5,// * random(0, 2),
            bumpinessMultiplier: 5,// * random(0, 2),
            tetrisRewardMultiplier: -100,// * random(0, 2)
        };
    }
